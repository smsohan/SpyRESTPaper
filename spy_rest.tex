...
The source code for both the Spy and Web app components are released as open source projects. Even though Node.js, MongoDB and Ruby on Rails are used for SpyREST implementation, the ideas that SpyREST realized are not dependent on these specific technologies.
