...
:
  ...
  \item Customizable: SpyREST needs to allow users to edit overview information in addition to the auto generated content as recommended by \cite{Robillard_what_makes}.
  \item Reusable: SpyREST needs to work as a reusable and shared platform so that multiple REST API documentations can be generated and published on a single platform to get the benefits as outlined by Stepalina \cite{Stepalina_saas}.
  \item Collaborative
\end{itemize}
